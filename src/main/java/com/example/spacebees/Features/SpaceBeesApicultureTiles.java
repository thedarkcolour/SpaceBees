...
import com.example.spacebees.Alveary.TileAlvearyLighting;
import com.example.spacebees.Alveary.TileAlvearyCreativeMutator;
import com.example.spacebees.Alveary.TileAlvearyRainShield;
...
public class SpaceBeesApicultureTiles {
    ...
    public static final FeatureTileType<TileAlvearyCreativeMutator> ALVEARY_MUTATOR = REGISTRY.tile(TileAlvearyCreativeMutator::new, "alveary_mutator", () -> SpaceBeesApicultureBlocks.ALVEARY.get(SpaceBeesBlockAlvearyType.MUTATOR).collect());
