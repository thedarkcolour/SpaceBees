...
public class SpaceBeesTileHive extends BlockEntity implements IHiveTile, IActivatable, IBeeHousing {
	...
	private final SpaceBeesHiveBeeHousingInventory inventory;
	private final SpaceBeesWorldgenBeekeepingLogic beeLogic;
	...
	public SpaceBeesTileHive(BlockPos pos, BlockState state) {
		super(SpaceBeesApicultureTiles.HIVE.tileType(), pos, state);

		this.inventory = new SpaceBeesHiveBeeHousingInventory(this);
		this.beeLogic = new SpaceBeesWorldgenBeekeepingLogic(this);
