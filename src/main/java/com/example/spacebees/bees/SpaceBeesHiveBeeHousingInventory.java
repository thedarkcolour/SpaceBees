...
class SpaceBeesHiveBeeHousingInventory implements IBeeHousingInventory {
	@Nullable
	private ItemStack queen;
	@Nullable
	private ItemStack drone;

	private final SpaceBeesTileHive hive;

	public SpaceBeesHiveBeeHousingInventory(SpaceBeesTileHive hive) {
		this.hive = hive;
	}
